...
class TreeNode:
    ...
    def __init__(self, value):
        ...
        # Through debugging I found that a tree with one node always said it had a height of three so I looked at the beginning of when it's created and found the problem.
        self.height: int = 0
...
class AVLTree:
    ...
    def _traverse_from_node(self, local_root: TreeNode) -> list:
        ...
        if local_root:  # I found through debugging that the program was always skipping the statements in the if statement and it doesn't make sense to write 'is None' here.
    ...
    def _insert_at(self, root: TreeNode, new) -> TreeNode:
        ...
        if root is None:
            ...
            # Add to the left
            # Found through debugging as nodes that should be added to the left were being added to the right and this is a clear typo
