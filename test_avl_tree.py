...
class TestAVLTree(unittest.TestCase):
    def compare_tree_expected(self, values: list):
        ...
        expected_height = math.ceil(
            math.log2(len(expected))) if expected else 0
        self.assertAlmostEqual(
            expected_height, tree._get_height(tree.root), delta=2)
    ...
    def test_big_trees_jumbled_uniques(self):
        ...
        self.compare_tree_expected(
            [1, 5, 3, 4, 5, 6, 7, 3, 2, 4, 5, 6, 4, 4, 5, 6, 4, 5, 6, 4, 6, 5, 5, 4, 5, 6, 7])
    ...
    def test_massive_random_tree1(self):
        ...
        self.compare_tree_expected([random.randint(0, 10)
                                   for _ in range(1000)])
